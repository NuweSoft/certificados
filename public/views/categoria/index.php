...
<body class="g-sidenav-show  bg-gray-200">
                    ...
                    <div class="card" data-animation="true">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <a class="d-block blur-shadow-image">
                                <img src="<?php echo BASE_URL ?>public/assets/img/sistema/categoria.png" alt="img-blur-shadow" class="img-fluid shadow border-radius-lg" style=" width: 100%; height: 300px;">
                            </a>
                            <div class="colored-shadow" style="background-image: url(&quot;<?php echo BASE_URL ?>public/assets/img/sistema/categoria.png&quot;); height: 100%; position: absolute; top: 0px; left: 0px; background-size: cover; "></div>
                        </div>
                        <div class="card-body text-center">
                            <div class="d-flex mt-n6 mx-auto justify-content-center">
                                <button class="btn btn-outline-dark bg-gradient-dark  btn-sm text-center hover-scale hover-shadow" onclick="Mcategoria(event);"><i class="fa fa-plus"></i> Nuevo</button>
                            </div>
                            <p class="mb-0 mt-3">
                        ...
                        <div class="card-header">
                            <div class="d-sm-flex justify-content-between">
                                ...
                                <div class="d-flex gap-1">
                                    <button id="mod" class="btn btn-outline-dark bg-gradient-dark  btn-sm text-center hover-scale hover-shadow" onclick="Mcategoria(event);"><i class="fa fa-plus"></i> Nuevo</button>
                                </div>
                            </div>
    ...
    <script src="<?php echo BASE_URL ?>public/views/categoria/categoria.js"></script>
</body>
